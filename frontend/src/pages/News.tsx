        ...
        <div className="max-w-7xl mx-auto px-4 py-8 bg-[#F8FAFC]">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-2 text-xs font-semibold text-slate-400">
                    ...
                    <span>/</span>
                    <span className="text-slate-800 font-bold">Haberler</span>
                </div>
            ...
            <div className="bg-gradient-to-r from-[#0C1425] to-emerald-950 text-white rounded-3xl p-8 md:p-10 mb-8 border border-slate-800 shadow-xl shadow-slate-900/5 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl">
                    <span className="text-[10px] font-extrabold uppercase tracking-widest text-emerald-400 bg-white/10 px-3 py-1 rounded-full border border-white/5">FAALİYET GÜNCELERİ</span>
                    <h1 className="font-heading text-2xl md:text-4xl font-extrabold mt-3 tracking-tight">Haberler & Duyurular</h1>
                    <p className="text-slate-300 text-xs md:text-sm mt-2 font-medium">Sivil toplum portalımızın en yeni sosyal yardım faaliyetleri, saha projeleri ve güncel insani yardım gelişmelerini buradan takip edebilirsiniz.</p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-slate-100/50 p-6 md:p-8 border border-slate-100">
                ...
                {isLoading && (
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <span className="text-sm font-semibold text-slate-500">Haberler yükleniyor...</span>
                    </div>
                )}
                ...
                {!isLoading && !error && (
                    filteredNews.length > 0 ? (
                        ...
                        <div className="text-center py-16 text-slate-400 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                            {searchQuery ? '🔍 Arama kriterlerinize uygun faaliyet haberi bulunamadı.' : '📢 Portala ait henüz yayınlanmış faaliyet haberi bulunamadı.'}
                        </div>
                    )
                )}
            </div>
