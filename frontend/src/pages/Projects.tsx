        ...
        <div className="max-w-7xl mx-auto px-4 py-8 bg-background transition-colors duration-300">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center gap-2 text-xs font-semibold text-slate-400">
                    ...
                    <span>/</span>
                    <span className="text-slate-800 dark:text-slate-200 font-bold">Projelerimiz</span>
                </div>
            ...
            <div className="bg-gradient-to-r from-[#0C1425] to-emerald-900 text-white rounded-3xl p-8 md:p-10 mb-8 border border-slate-800 shadow-xl shadow-slate-900/5 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl">
                    <span className="text-[10px] font-extrabold uppercase tracking-widest text-emerald-300 bg-white/10 px-3 py-1 rounded-full border border-white/5">SOSYAL SORUMLULUK</span>
                    <h1 className="font-heading text-2xl md:text-4xl font-extrabold mt-3 tracking-tight">Sürdürülebilir Sosyal Projelerimiz</h1>
                    <p className="text-slate-300 text-xs md:text-sm mt-2 font-medium">Çukurca halkı ve destekçilerimizle birlikte hayata geçirdiğimiz kalkınma, eğitim ve kültür projeleri.</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl dark:shadow-black/20 p-6 md:p-8 border border-slate-100 dark:border-slate-800/80">
                ...
                {error && (
                    <div className="text-center py-12 px-4 bg-rose-50 dark:bg-rose-955/20 rounded-2xl border border-rose-100 dark:border-rose-900/35 max-w-md mx-auto my-8">
                        ...
                        <p className="text-sm font-semibold text-rose-800 dark:text-rose-455">Projeler yüklenirken bir sorun oluştu.</p>
                ...
                {!isLoading && !error && (
                    filteredProjects.length > 0 ? (
                        ...
                        <div className="text-center py-16 text-slate-400 dark:text-slate-550 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
                            {searchQuery ? "Aramanızla eşleşen proje bulunamadı." : "Yayınlanmış proje bulunmamaktadır."}
                        </div>
                    )
                )}
            </div>
